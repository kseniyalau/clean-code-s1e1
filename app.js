...
var incompleteTaskHolder=document.querySelector(".tasks-list_incompleted");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className='task-name tasks-list__label';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="tasks-list__checkbox";
    editInput.type="text";
    editInput.className="task-name task-name-input tasks-list__input";
    ...
    deleteButtonImg.alt='Cross sign icon';
